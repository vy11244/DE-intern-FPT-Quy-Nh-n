...
table_lake = "customers" #Folder that contains wanted tables from blob
table_target = "Transaction.Customers"
module_name = "TRANSACTION"
target_primary_key = "CustomerID"

upload_method = "replace"
#Upload method is either insert, upsert or replace
json_file_name = "transaction.customers_mapping.json"
