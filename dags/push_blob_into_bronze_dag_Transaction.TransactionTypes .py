...
table_lake = "TransactionTypes" #Folder that contains wanted tables from blob
table_target = "Transaction.TransactionTypes"
module_name = "TRANSACTION"
target_primary_key = "TRANSACTIONTYPEID"

upload_method = "replace"
#Upload method is either insert, upsert or replace
json_file_name = "Transaction.Transactiontypes_mapping.json"
