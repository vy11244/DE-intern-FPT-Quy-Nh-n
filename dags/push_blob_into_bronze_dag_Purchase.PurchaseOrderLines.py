...
table_lake = "PurchaseOrderLines" #Folder that contains wanted tables from blob
table_target = "Purchase.PurchaseOrderLines"
module_name = "PURCHASE"
target_primary_key = "PURCHASEORDERLINEID"

upload_method = "upsert"
#Upload method is either insert, upsert or replace
json_file_name = "Purchase.PurchaseOrderLines_mapping.json"
