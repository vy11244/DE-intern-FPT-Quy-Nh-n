...
table_lake = "CustomerTransactions" #Folder that contains wanted tables from blob
table_target = "Transaction.CustomerTransactions"
module_name = "TRANSACTION"
target_primary_key = "CUSTOMERTRANSACTIONID"

upload_method = "upsert"
#Upload method is either insert, upsert or replace
json_file_name = "Transaction.CustomerTransactions_mapping.json"
