...
table_lake = "StockItemHoldings" #Folder that contains wanted tables from blob
table_target = "StockHolding.StockItemHoldings"
module_name = "STOCKHOLDING"
target_primary_key = "STOCKITEMID"

upload_method = "upsert"
#Upload method is either insert, upsert or replace
json_file_name = "StockHolding.StockItemHoldings_mapping.json"
