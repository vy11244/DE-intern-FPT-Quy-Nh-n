...
from dataUtils import BlobStorageHandler, SqlFileHandler, MSSQLHandler, DataExtractor

table_source = "Purchasing.SupplierTransactions"
query_file_name = "SupplierTransaction_Fact.sql"
...
with DAG(
    ...
    extract_source_into_local_task = data_extractor.create_mssql_dag_task_local(dag, table_source, query_file_name, is_fact=True)
