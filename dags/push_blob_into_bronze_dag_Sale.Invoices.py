...
table_lake = "INVOICES" #Folder that contains wanted tables from blob
table_target = "Sale.Invoices"
module_name = "SALE"
target_primary_key = "INVOICEID"

upload_method = "upsert"
#Upload method is either insert, upsert or replace
json_file_name = "Sale.invoices_mapping.json"
