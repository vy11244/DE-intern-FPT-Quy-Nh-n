...
table_lake = "PurchaseOrders" #Folder that contains wanted tables from blob
table_target = "Purchase.PurchaseOrders"
module_name = "PURCHASE"
target_primary_key = "PURCHASEORDERID"

upload_method = "upsert"
#Upload method is either insert, upsert or replace
json_file_name = "Purchase.PurchaseOrders_mapping.json"
