...
table_lake = "StockItemTransactions" #Folder that contains wanted tables from blob
table_target = "MOVEMENT.StockItemTransactions"
module_name = "MOVEMENT"
target_primary_key = "STOCKITEMTRANSACTIONID"

upload_method = "upsert"
#Upload method is either insert, upsert or replace
json_file_name = "Movement.StockItemTransactions_mapping.json"
