...
table_lake = "StockItems" #Folder that contains wanted tables from blob
table_target = "StockHolding.StockItems"
...
json_file_name = "StockHolding.StockItems_mapping.json"
