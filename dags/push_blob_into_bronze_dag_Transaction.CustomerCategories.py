...
table_lake = "customercategories" #Folder that contains wanted tables from blob
table_target = "Transaction.CustomerCategories"
module_name = "TRANSACTION"
target_primary_key = "CustomerCategoryID"

upload_method = "replace"
#Upload method is either insert, upsert or replace
json_file_name = "transaction.customercategories_mapping.json"
