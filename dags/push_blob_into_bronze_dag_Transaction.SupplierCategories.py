...
table_lake = "SupplierCategories" #Folder that contains wanted tables from blob
table_target = "Transaction.SupplierCategories"
module_name = "Transaction"
target_primary_key = "SUPPLIERCATEGORYID"

upload_method = "replace"
#Upload method is either insert, upsert or replace
json_file_name = "Transaction.SupplierCategories_mapping.json"
