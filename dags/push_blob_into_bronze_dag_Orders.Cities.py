...
table_lake = "Cities" #Folder that contains wanted tables from blob
table_target = "ORDERS.Cities"
module_name = "ORDERS"
target_primary_key = "CITYID"

upload_method = "replace"
#Upload method is either insert, upsert or replace
json_file_name = "Orders.Cities_mapping.json"
