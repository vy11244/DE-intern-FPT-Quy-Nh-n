...
table_lake = "Orders" #Folder that contains wanted tables from blob
table_target = "ORDERS.Orders"
module_name = "ORDERS"
target_primary_key = "ORDERID"

upload_method = "upsert"
#Upload method is either insert, upsert or replace
json_file_name = "Orders.Orders_mapping.json"
