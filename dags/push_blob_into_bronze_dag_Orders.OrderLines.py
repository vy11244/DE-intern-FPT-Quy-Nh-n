...
table_lake = "OrderLines" #Folder that contains wanted tables from blob
table_target = "ORDERS.OrderLines"
module_name = "ORDERS"
target_primary_key = "ORDERLINEID"

upload_method = "upsert"
#Upload method is either insert, upsert or replace
json_file_name = "Orders.OrderLines_mapping.json"
