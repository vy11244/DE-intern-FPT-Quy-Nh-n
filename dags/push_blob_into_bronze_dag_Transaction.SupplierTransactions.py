...
table_lake = "SupplierTransactions" #Folder that contains wanted tables from blob
table_target = "Transaction.SupplierTransactions"
module_name = "TRANSACTION"
target_primary_key = "SUPPLIERTRANSACTIONID"

upload_method = "upsert"
#Upload method is either insert, upsert or replace
json_file_name = "Transaction.SupplierTransactions_mapping.json"
