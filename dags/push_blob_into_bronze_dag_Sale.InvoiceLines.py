...
table_lake = "INVOICELINES" #Folder that contains wanted tables from blob
table_target = "Sale.InvoiceLines"
module_name = "SALE"
target_primary_key = "INVOICELINEID"

upload_method = "upsert"
#Upload method is either insert, upsert or replace
json_file_name = "Sale.invoicelines_mapping.json"
