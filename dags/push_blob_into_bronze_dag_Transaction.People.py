...
table_lake = "people" #Folder that contains wanted tables from blob
table_target = "Transaction.People"
module_name = "TRANSACTION"
target_primary_key = "PersonID"

upload_method = "replace"
#Upload method is either insert, upsert or replace
json_file_name = "transaction.people_mapping.json"
