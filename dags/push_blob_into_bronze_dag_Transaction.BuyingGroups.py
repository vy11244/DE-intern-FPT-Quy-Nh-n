...
table_lake = "buyinggroups" #Folder that contains wanted tables from blob
table_target = "Transaction.BuyingGroups"
module_name = "TRANSACTION"
target_primary_key = "BuyingGroupID"

upload_method = "replace"
#Upload method is either insert, upsert or replace
json_file_name = "transaction.buyinggroups_mapping.json"
