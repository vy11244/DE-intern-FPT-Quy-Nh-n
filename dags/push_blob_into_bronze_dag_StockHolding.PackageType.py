...
table_lake = "PackageTypes" #Folder that contains wanted tables from blob
table_target = "StockHolding.PackageTypes"
module_name = "STOCKHOLDING"
target_primary_key = "PACKAGETYPEID"

upload_method = "replace"
#Upload method is either insert, upsert or replace
json_file_name = "StockHolding.PackageTypes_mapping.json"
