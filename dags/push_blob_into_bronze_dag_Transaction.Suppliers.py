...
table_lake = "Suppliers" #Folder that contains wanted tables from blob
table_target = "Transaction.Suppliers"
module_name = "TRANSACTION"
target_primary_key = "SUPPLIERID"

upload_method = "replace"
#Upload method is either insert, upsert or replace
json_file_name = "Transaction.suppliers_mapping.json"
